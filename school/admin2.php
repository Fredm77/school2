<?php
if(isset($_POST["reg"] ) and isset($_POST["name"])){
    $reg=$_POST["reg"];
    $name=$_POST["name"];
    $connect=mysqli_connect("localhost","root","","school");
    $q=mysqli_query($connect,"select * from reg_number where reg_number.reg_num='$reg';");
    ...
    <div class="container-fluid">
        <div class="center">
            ...
            <form method="post" action="admin2.php">
               ...
               <div class="pass">Forgot Reg Number?</div>
...
if(isset($_POST["login"])){
    ...
    if($q){
        ...
        echo "<script>alert('Your Registration Number is not Correct')</script>";
    }
}
?>